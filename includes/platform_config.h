...
#if !defined (USE_STM3210B_EVAL) &&  !defined (USE_STM3210E_EVAL) &&  !defined (USE_STM32L152_EVAL) &&  !defined (USE_STM32L152D_EVAL)&&  !defined (USE_STM32373C_EVAL) &&  !defined (USE_STM32303C_EVAL) && !defined(USE_DRAGON_BOARD)
...
#elif defined (USE_STM3210E_EVAL) || defined (USE_DRAGON_BOARD)
